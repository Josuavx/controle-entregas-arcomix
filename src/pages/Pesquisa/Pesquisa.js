...
import foto from '../../Components/imgs/fotoresidencia.png'
...
export default function Impressoes() {
    ...
    return(
        <div>
            <Header/>
            <div class="impP">
                <nav className="navegacaoP">
                        <button>Pesquisar</button>
                        <button>Limpar</button>
                        <button>Adicionar</button>
                        <button>Removar</button>
                        <button>Imprimir</button>
                        <button>Solicitações</button>
                </nav>
                <div class= "form-containerP">
                    <form class="formP" action="/fornecedor" method="POST">
                        <div class="imagemP">
                        <img src={foto}alt="Descrição da imagem" id='fotoP'/>
                        </div>
                        <div class="org-formP" id='div1'>
                            <div>
                            <label class='labelPesquisa' for="nome">Fornecedor:</label>
                            <input placeholder='848624' class= 'textP' type="text" id="nome" name="nome" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="razaoSocial">Razão Social:</label>
                            <input placeholder='J & C Frios Ltda' class= 'textP' type="text" id="razaoSocial" name="razaoSocial" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="logradouro">Logradouro:</label>
                            <input placeholder='BR 101 - SUL S/N' class= 'textP' type="text" id="logradouro" name="logradouro" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="cnpj">CNPJ:</label>
                            <input placeholder=' 13335223/0001-14' class= 'textP' type="text" id="cnpj" name="cnpj" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="telefones">Telefones:</label>
                            <input placeholder='81 1564-4682' class= 'textP' type="text" id="telefones" name="telefones" required/>
                            <input placeholder='81 4002-8922' class= 'textP' type="text" id="telefones1" name="telefones" required/>
                            </div>
                        </div>
                        <div class="org-form" id='div2'>
                            <div>
                            <label class='labelPesquisa' for="segmento">Segmento:</label>
                            <input placeholder='Alimentos' class= 'textP'type="text" id="segmento" name="segmento" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="bairro">Bairro:</label>
                            <input placeholder='848624' class= 'textP'type="text" id="bairro" name="bairro" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="cidade">Cidade:</label>
                            <input placeholder='Jaboatão dos guararapes' class= 'textP'type="text" id="cidade" name="cidade" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="cep">CEP:</label>
                            <input placeholder='848651645502' class= 'textP' type="text" id="cep" name="cep" required/>
                            </div>
                            <div>
                            <label class='labelPesquisa' for="email">Email:</label>
                            <input placeholder='jc@gmail.com' class= 'emailP' type="email" id="email" name="email" required/>
                            </div>
                            <Link to="/problemas">
                                <input class='ProblemasP' type="submit" value="Problemas"/>
                            </Link>
                        </div>
                    </form>
                    </div>
                <div class="impressoesP">
                    <table>
                        <thead>
                            <tr>
                                <th id="firstthP"><input type="checkbox" checked={verifySelectAll} onChange={handleFirstCheckboxChange}/></th>
